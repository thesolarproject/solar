package com.solar.launcher.feature.home;
...
public final class HomeMenuConfig {
    ...
    private static final Entry[] CATALOG = {
            new Entry(ID_NOW_PLAYING, R.string.home_menu_now_playing, "nowPlaying", android.R.drawable.ic_menu_more, null, false),
            new Entry(ID_MUSIC, R.string.home_menu_music, "music", android.R.drawable.ic_menu_more, null, false),
            new Entry(ID_BLUETOOTH, R.string.home_menu_bluetooth, "bluetooth", android.R.drawable.ic_menu_more, null, false),
            new Entry(ID_SETTINGS, R.string.home_menu_settings, "settings", android.R.drawable.ic_menu_more, null, true),
            new Entry(ID_FM, R.string.home_menu_fm, "fm", android.R.drawable.ic_menu_more, null, false),
            new Entry(ID_PC_UPLOAD, R.string.home_menu_pc_upload, null, android.R.drawable.ic_menu_more, "PC Upload", false),
            new Entry(ID_PODCASTS, R.string.home_menu_podcasts, null, android.R.drawable.ic_menu_more, "Podcasts", false),
            new Entry(ID_SOULSEEK, R.string.home_menu_soulseek, null, android.R.drawable.ic_menu_more, "Reach", false),
            new Entry(ID_THEMES, R.string.home_menu_themes, "theme", android.R.drawable.ic_menu_more, "Themes", false),
            new Entry(ID_VIDEOS, R.string.home_menu_videos, "video", android.R.drawable.ic_menu_more, null, false),
            new Entry(ID_PHOTOS, R.string.home_menu_photos, "photos", android.R.drawable.ic_menu_more, null, false),
            new Entry(ID_AUDIOBOOKS, R.string.home_menu_audiobooks, "audiobooks", android.R.drawable.ic_menu_more, null, false),
            new Entry(ID_APPS, R.string.home_menu_apps, null, android.R.drawable.ic_menu_more, "Apps", false),
    };
