...
public final class PlayQueue {
    ...
    public static final class QueueItem {
        ...
        public static QueueItem podcast(QueueEpisode ep, String showTitle, boolean fromSaved) {
    ...
    public List<QueueEpisode> podcastEpisodes() {
