...
print("- `rom.zip` — Y1 type A ATA (y1-community/y1-ata-rom, MT6572)")
print("- `rom_type_b.zip` — Y1 type B ATA (y1-community/y1-ata-rom, MT6572)")
print("- `rom_y2.zip` — Innioasis Y2 ATA (y1-community/y2-ata-rom, MT6582)")
print("- `rom_a5.zip` — Timmkoo A5 ATA (y1-community/a5-ata-rom, MT6572)")
print()
